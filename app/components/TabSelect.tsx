          ...
          <div key={id} className="relative px-3 py-2 text-xs">
            ...
            <button
              ...
              className={twMerge(
                ...
                "focus-ring absolute inset-0 z-10 rounded-md bg-transparent font-medium text-gray-500 transition-all hover:text-gray-900 focus-visible:ring-offset-gray-100 dark:text-gray-400 dark:hover:text-gray-100 dark:focus-visible:ring-offset-gray-800",
